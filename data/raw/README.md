...
- **SIET** (`siet.*`): Datos de `https://siet.mineducacion.gov.co/` — educacion para el trabajo y desarrollo humano
...
- **SENA** (`competencias.*`, `sena.*`, `tendencias_laborales.*`): Agencia Publica de Empleo, formacion profesional integral, mesas sectoriales
...
El repositorio DuckDB (`data/repositorio.duckdb`) contiene 56 esquemas con ~316 tablas. La documentacion detallada de cada fuente se encuentra en `docs/tecnica/05_fuentes_datos.md`.
